...
The calibration data are read from `S1_Calibration_data_and_fitting_results.xlsx`. Data used in the fitting are experimental data from Gorojovky & Wood (2026), O'Neill & Mavrogenes (2002), O'Neill and Mavrgoenes (2022), Boulliung & Wood (2022), and Boulliung & Wood (2023). The fitted model form is:
